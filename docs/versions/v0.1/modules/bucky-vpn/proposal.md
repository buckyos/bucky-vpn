...
approved_content_sha256: c5656b93621e454fdcaa3d03e95b6caa52c05669ab62ab7e706c6fb157280b6d
---
...
| ui/datamodel/workflow | yes | `join` / `state` CLI 需要使用配置化本地 API 地址连接 daemon，并以 base36 展示/传递 NodeId。 | design 必须保证默认 CLI 工作流不变，只有显式配置时切换地址；NodeId 输出与服务端 API 合同一致。 |  |
